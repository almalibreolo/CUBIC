...
(function ($) {
    $.fn.extend({
        layout: function (options) {
            ...
            function getColumn(container, length, width, height) {
            ...
            function getColumnPosition(parent, list, size, parentWidth, parentHeight, gap, padding) {
                ...
                var columns = getColumn(parent, list.length, parentWidth, parentHeight);
            ...
            function getColumnSize(parent, list, parentWidth, parentHeight, gap, padding) {
                ...
                var column = getColumn(parent, list.length, parentWidth, parentHeight);
                ...
                if (size.length > 0) {
                    var s = size[0];
                    var c = column.cols;
                    for (var j = 1, sll = size.length; j < sll; j++) {
                        for (var v = 0, coll = column.cols; v < coll; v++) {
                            var tw = size[j].width[v];
                            var th = size[j].height[v];
                            if (!tw) {
                                break;
                            }
